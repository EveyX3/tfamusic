...
import { Guild, GuildMember, GuildTextBasedChannel, Interaction, PermissionsBitField, User, Collection } from 'discord.js';
	...
	return {
		...
		get clientToMember() {
			if (
				...
				return `${emojis.error} | You must be in my voice channel`;
		}
	};
}
